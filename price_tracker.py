...
Info  : https://brightdata.jp/products/insights/price-tracker/swiggy
"""
...
# https://brightdata.jp/products/web-scraper/swiggy
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Swiggy scraper at: https://brightdata.jp/products/web-scraper/swiggy\n"
